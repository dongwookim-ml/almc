...
We demonstrate that the compositional knowledge factorisation results a better performance on the missing relation prediction, whereas the model shows a worse performance on the active knowledge acquisition.
