...
\item We propose an incremental knowledge population method that searches the factorised space, trading of exploration and exploitation using Thompson sampling (Section \ref{sec:pts}).
