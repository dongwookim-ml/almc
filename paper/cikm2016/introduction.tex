...
\item Experiments show the importance of uncertainty in the active acquisition. Especially, the better predictive model does not guarantee to have a better knowledge acquisition due to an improper uncertainty measure in Section \ref{sec:exp2}.
\end{itemize}
