...
With the compositions of relations, the \textsc{Prescal} may place a different relation matrix $R_c$ for each composition $c$. However, the number of required matrices increases exponentially, as the length of composition increases linearly. Consequently, the computational cost will also increases exponentially.
