...
To compare with the additive model, the multiplicative model preserves the ordering in a compositional relation, and hence the different orderings of relations result different relations in the compositional model. 
