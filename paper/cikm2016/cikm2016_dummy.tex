...
\newcommand{\tablemoveup}{\eqmoveup\vspace{-5mm}}   %{\vspace{-0.16in}}
...
\doi{http://dx.doi.org/10.1145/2983323.2983677}
...
\alignauthor Lexing Xie\\
      \affaddr{ANU \& Data to Decision CRC}\\
      \affaddr{Australia}\\
...
\vspace{2mm}\smallhead{Acknowledgments} This work is supported in part by the Australian Research Council via the Discovery Project program DP140102185.
The work has been supported by the Data to Decisions Cooperative Research Centre whose activities are funded by the Australian Commonwealth Government's Cooperative Research Centres Programme.
