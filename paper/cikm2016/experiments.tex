...
In this section, we show results for Thomson sampling and compositions for PRESCAL. 
...
\eat{
In this section, we verify the Thompson sampling for probablistic RESCAL (PRESCAL) 
...
%	\includegraphics[width=0.32\linewidth]{images/toy_10_5_5.pdf}				
	\caption{\label{fig:synthetic} Cumulative regret of particle Thompson sampling with Gaussian and logistic output ({\sc PNORMAL, PLOGIT}) against Passive learning 
...
\begin{figure*}[t]
	...
	\caption{\label{fig:vs_greedy}Comparison between probabilistic RESCAL and greedy models. }
\end{figure*}
...
\begin{figure*}[t]
	...
	\caption{\label{fig:vs_comp} Comparison between active PRESCAL, passive PRESCAL, and AMDC models.}
\end{figure*}
...
\begin{figure*}[t]
	...
	\caption{\label{fig:tsne} Embedding multi-dimensional entities in the NATION dataset into the two-dimensional space through tSNE\cite{VanDerMaaten2008}. The size of circle in PNORMAL is proportional to the uncertainty of embeddings in the projected space.}
\end{figure*}