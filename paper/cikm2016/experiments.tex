...
\begin{figure*}[t]
	...
	\caption{\label{fig:}Comparison between probabilistic RESCAL and greedy models. }
\end{figure*}
...
\begin{figure*}[t]
	...
	\caption{\label{fig:} Comparison between active PRESCAL, passive PRESCAL, and AMDC models.}
\end{figure*}
