...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.8\linewidth]{images/path_prediction.pdf}
...
\center
\small
\caption{\label{tbl:path_example} Example of path prediction from UMLS data. We predict triple and path starting from entity \texttt{Mental-or-Behavioral (MB) Dysfunction} followed by two relations: \texttt{Affects}, and \texttt{Produces}. Correct entities are bolded.}
...
Model & Top 1 & Top 2 & Top 3 & Top 4 & Top 5 \\ \hline
