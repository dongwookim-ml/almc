...
\section{Missing Triple Prediction}
\label{sec:exp1}
...
%	}
	...
	\caption{\label{fig:pos_var} Trace plot of mean posterior variance of the non-compositional model and compositional models.}
\end{figure}
