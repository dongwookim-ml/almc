...
This is not a natural choice since the triple is usually represented as a binary variable, however, we can control the confidence on different observations
...
Closed form of the posterior means and precision matrices are listed in Table~\ref{tab:brescalposterior}, where we have
