...
We develop a Gibbs sampler to perform the posterior inference for the probabilistic \textsc{Rescal} (\textsc{Prescal}). The conditional distribution of each latent variable is given by:
\begin{align}
