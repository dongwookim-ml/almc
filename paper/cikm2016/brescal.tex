...
Alternatively, one may want to model the binary observation more precisely.
...
$E$ and $R$ by the Laplace approximation~\cite{bishop2006pattern} through an alternative sampling. The detailed derivations are provided in the appendix\footnote{The appendix is available at: http://cm.cecs.anu.edu.au/post/prescal}.
\eat{
