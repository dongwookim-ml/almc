...
\center
\small
\caption{\label{tbl:path_example} Example of path prediction from UMLS data. We predict top 5 entities in a compositional triples starting from entity \texttt{Mental-or-Behavioral (MB) Dysfunction} followed by two relations, \texttt{Affects} and \texttt{Produces}. Correct entities are bolded.}
