...
\begin{figure}[t]
	...
	Both compositional models show consistent predictive performance 
...
Both compositional model shows consistent performance regardless of the compositional length. 
