...
\captionof{figure}{Composition of multiple triples can be interpreted as a \textbf{compositional triple}. We augment the original tensor with these additional triples to incorporate explicit path structure into factorisation.}
\end{center}
