...
\captionof{figure}{Multiple consecutive triples form a \textbf{compositional triple}. We augment the original tensor with compositional additional triples to explicitly incorporate path structure into factorisation.}
\end{center}
