...
\begin{abstract}
  ...
  We are concerned with the problem of knowledge base completion, or inferring missing facts 
...
Human can readily infer the new fact through the composition of known facts in   knowledge base,
whereas the current statistical relational models lacks the consideration of
active knowledge acquisition through the composition of knowledge.
  We propose a probabilistic model to bridge this gap. 
  We start from a new formulation of vector space embedding for knowledge tensors, 
  %which generalises the RESCAL model to 
