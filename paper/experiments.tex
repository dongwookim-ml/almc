...
%	\includegraphics[width=0.32\linewidth]{images/toy_10_5_5.pdf}				
	...
	The averaged cumulative regrets \verify{over X runs} are plotted with one standard error. 
...
\TODO{TODO}{swapped 6.2 and 6.3 as discussed. smooth the text, look out for inconsistencies.}
