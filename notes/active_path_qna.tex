...
%\item \textbf{Negative path} $n = (e_i, W_{k_1}, W_{k_2}, ... , W_{k_L}, e_j)$. We can find one or more paths from entity $i$ to entity $j$ through a sequence of relations $k_1 / k_2 / \dots / k_L$ on $\Lambda - \mathcal{G}$.

%\item \textbf{Complementary negative path} $n' = (e_i, W_{k_1}, W_{k_2}, ... , W_{k_L}, e_{j'})$. We cannot find any path from entity $i$ to entity $j'$ through a sequence of relations $k_1 / k_2 / \dots / k_L$ on  $\Lambda - \mathcal{G}$.
